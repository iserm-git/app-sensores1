    ...
    return (
      <View style={styles.visualizerContainer}>
        ...
        <View style={styles.visualizerPlane}>
          ...
          <View
            style={[styles.guideLine, { transform: [{ rotate: "90deg" }] }]}
          />
          ...
          <View style={styles.axisIndicators}>
            <Text style={[styles.axisIndicator, { left: 10, top: "50%" }]}>
              -X
            </Text>
            <Text style={[styles.axisIndicator, { right: 10, top: "50%" }]}>
              +X
            </Text>
            <Text style={[styles.axisIndicator, { top: 10, left: "50%" }]}>
              +Y
            </Text>
            <Text style={[styles.axisIndicator, { bottom: 10, left: "50%" }]}>
              -Y
            </Text>
          </View>
        </View>
    ...
    >
      ...
      <View style={styles.infoBox}>
        ...
        {type === "accelerometer" ? (
          ...
          <>
            <Text style={styles.infoText}>
              • X: Rotación sobre eje X (pitch)
            </Text>
            <Text style={styles.infoText}>
              • Y: Rotación sobre eje Y (roll)
            </Text>
